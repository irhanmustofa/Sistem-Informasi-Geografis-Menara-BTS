...
$id_petugas = $_SESSION["petugas"] ["id_user"];
		...
		<div class="row">
			<nav id="sidebar" class="col-md-3 col-lg-2 position-fixed start-0 top-0 bottom-0 py-5 collapse d-md-block sidebar" style="background: #0C3B0C;">
				<div class="container mt-4 text-center">
					<img src="../assets/img/<?php echo $petugas["foto_admin"] ?>" width="60" style="border-radius: 50%;">
					<h6 class="text-white py-2"><?php echo $petugas["nama_user"]; ?></h6>
				</div>
				<div class="pt-3">
					<ul class="nav flex-column">
						...
						<li class="nav-item">
							<a class="nav-link text-white" href="datamenara.php">
						...
						<li class="nav-item">
							<a class="nav-link text-white" href="peta.php">
